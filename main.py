...
about_video1="https://gitee.com/kabigo/tv/raw/master/assets/about1080p.mp"
about_video2="https://gitlab.com/p2v5/wangtv/-/raw/main/about1080p.mp"
luyou="路由器打开,"+about_video1
...
# 
all_lines =  ["更新时间,#genre#"] +[version]  +[luyou]  +[ipv]  +[zhibo] +[daily_mtv] +[about] +[daily_mtv]+read_txt_to_array('专区/about.txt') + ['\n'] +\
             ["💓专享源🅰️,#genre#"] + read_txt_to_array('专区/♪专享源①.txt') + ['\n'] + \
             ["💓专享源🅱️,#genre#"] + read_txt_to_array('专区/♪专享源②.txt') + ['\n'] + \
             ["📺央视频道,#genre#"] + read_txt_to_array('专区/♪优质央视.txt') + ['\n'] + \
             ...
             ["📡ipv4央视卫视,#genre#"] + read_txt_to_array('ipv4直播源/ipv4.txt') + ['\n'] + \
             ["🌊港·澳·台频道,#genre#"] + read_txt_to_array('专区/♪港澳台.txt') + ['\n'] + \
             ["💓 AKTV📶,#genre#"] + read_txt_to_array('专区/AKTV.txt') + ['\n'] + \
             ["📶台湾台,#genre#"] + read_txt_to_array('专区/♪台湾台.txt') + ['\n'] + \
             ["🏛经典剧场,#genre#"] + read_txt_to_array('专区/♪电视剧.txt') + ['\n'] + \
             ["💓优质个源,#genre#"] + read_txt_to_array('专区/♪优质源.txt') + ['\n'] + \
             ["🪁动画频道,#genre#"] + read_txt_to_array('专区/♪儿童专享.txt') + ['\n'] + \
             ["🎥咪咕直播,#genre#"] + read_txt_to_array('专区/♪咪咕直播.txt') + ['\n'] + \
             ["🏀SPORTS⚽️,#genre#"] + read_txt_to_array('专区/♪sports.txt') + ['\n'] + \
